      ...
      <div class="footer-grid">
        ...
        <div class="footer-col footer-col-brand">
          <NuxtLink to="/" class="footer-logo-link">
            <img src="/images/logo.png" alt="ProSicht" class="footer-logo-img" />
          </NuxtLink>
          ...
          <div class="footer-socials">
            ...
            <a href="https://twitter.com" target="_blank" rel="noopener" class="footer-social-link" aria-label="X (Twitter)">
              <svg viewBox="0 0 24 24" fill="currentColor" class="social-icon">
        ...
        <div class="footer-col">
          ...
          <ul class="footer-list">
            ...
            <li><a href="/#contributions" class="footer-nav-link">{{ $t('nav.about') }}</a></li>
            <li><NuxtLink to="/blog" class="footer-nav-link">Blog</NuxtLink></li>
            <li><a href="/#contact" class="footer-nav-link">{{ $t('nav.contact') }}</a></li>
          </ul>
        </div>

        <div class="footer-col">
          <h4 class="footer-col-title">{{ $t('nav.contact') }}</h4>
          <ul class="footer-list footer-contact-list">
            <li class="footer-contact-item">
              ...
              <span>Sakarya Teknokent, Serdivan / Sakarya</span>
            </li>
            <li class="footer-contact-item">
              <svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                <path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
          ...
          <ul class="footer-list footer-blog-list">
            <li v-for="post in recentPosts" :key="post.slug">
              <NuxtLink :to="`/blog/${post.slug}`" class="footer-blog-link">
                <span class="footer-blog-title">{{ post.title }}</span>
                <span class="footer-blog-date">{{ post.date }}</span>
              </NuxtLink>
            </li>
            <li v-if="!recentPosts?.length">
...
.footer-blog-link {
  ...
  border-radius: 8px;
  border-left: 2px solid rgba(61, 186, 162, 0.2);
  transition: all 0.2s ease;
}

.footer-blog-link:hover {
  border-left-color: #3DBAA2;
